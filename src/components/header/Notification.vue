<template>
  ...
  >
    <div slot="content">
      <a-list itemLayout="horizontal" bordered :dataSource="data">
      ...
      <div class="noti-sync">
        <span class="noti-sync-text">Synced at: 14 Mar 2019 17:36</span>
        <span class="noti-sync-icon" @click="toggleSync">
