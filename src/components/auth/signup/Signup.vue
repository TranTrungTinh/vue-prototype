...
<div class="login-form">
  <a-form :form="form" @submit="handleSubmit">
    ...
    <a-form-item class="login-form--item" hasFeedback :validateStatus="rules.status.confirmPassword">
      <a-input
...
export default {
  ...
  methods: {
    ...
    showStatusConfirmPassword() {
      return !!this.form.getFieldError('confirmPassword') ? 'error' : 'success';
    }
  },
  updated() {
    this.rules.status.password = this.showStatusPassword();
    this.rules.status.confirmPassword = this.showStatusConfirmPassword();
  }
};
</script>
